...
Route::group([
    ...
    Route::get("/create", "createForm")
        ->name("cars.createForm");
    Route::get("/update/{car}", "updateForm")
        ->name("cars.updateForm");

    Route::post("/create", "create")->name("cars.create");
    Route::post("/update/{car}", "update")
        ->name("cars.update");
    Route::delete("/delete/{car}", "delete")
        ->name("cars.delete");
});
...
Route::group([
    ...
    Route::get("/create", "createForm")
        ->name("services.createForm");
    Route::get("/update/{service}", "updateForm")
        ->name("services.updateForm");
...
Route::group([
    ...
    Route::get("/create", "createForm")
        ->name("mechanics.createForm");
    Route::get("/update/{mechanic}", "updateForm")
        ->name("mechanics.updateForm");

    Route::post("/create", "create")->name("mechanics.create");
    Route::post("/update/{mechanic}", "update")
        ->name("mechanics.update");
    Route::delete("/delete/{mechanic}", "delete")
